...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"settings.asr": "语音输入 (微信语音 → 文字 → 进入对话)",
			"settings.asrHint": "收到微信语音自动转为文本送入当前会话。语音自带服务端转写文本时直接用, 否则调用下方语音模型识别。",
			"settings.asrModel": "语音识别模型",
			"settings.asrModelPlaceholder": "mimo-v2.5-asr",
			"settings.asrBaseUrl": "语音识别接口",
			"settings.asrBaseUrlPlaceholder": "https://api.xiaomimimo.com/v1",
			"settings.asrKeyEnv": "语音识别 key (DSH 凭据/环境变量名)",
			"settings.asrKeyEnvHint": "默认 XIAOMI_API_KEY = DSH 里的 mimo key",
			"settings.asrLanguage": "语音语种 (auto/zh/en)",
		};
		const en = {
			...
			"settings.asr": "Voice input (WeChat voice → text → conversation)",
			"settings.asrHint": "Voice messages are transcribed to text and fed into the bound session. Uses the server-provided transcript when present, else the ASR model below.",
			"settings.asrModel": "ASR model",
			"settings.asrModelPlaceholder": "mimo-v2.5-asr",
			"settings.asrBaseUrl": "ASR base URL",
			"settings.asrBaseUrlPlaceholder": "https://api.xiaomimimo.com/v1",
			"settings.asrKeyEnv": "ASR key (DSH credential / env name)",
			"settings.asrKeyEnvHint": "Default XIAOMI_API_KEY = the mimo key in DSH",
			"settings.asrLanguage": "Language (auto/zh/en)",
		};
					...
					react_jsx_runtime.jsx("div", {
						...
						children: [
							react_jsx_runtime.jsx("label", {
								...
								children: [react_jsx_runtime.jsx("input", {
									type: "checkbox",
									checked: current.asrEnabled !== false,
									onChange: setField("asrEnabled"),
								}), t("settings.asr")]
							}),
							react_jsx_runtime.jsx("span", { style: pageStyle.status, children: t("settings.asrHint") }),
							react_jsx_runtime.jsx("label", {
								style: pageStyle.row,
								children: [react_jsx_runtime.jsx("span", { style: pageStyle.label, children: t("settings.asrModel") }), react_jsx_runtime.jsx("input", {
									style: pageStyle.input,
									value: current.asrModel ?? "",
									onChange: setField("asrModel"),
									placeholder: t("settings.asrModelPlaceholder"),
								})]
							}),
							react_jsx_runtime.jsx("label", {
								style: pageStyle.row,
								children: [react_jsx_runtime.jsx("span", { style: pageStyle.label, children: t("settings.asrBaseUrl") }), react_jsx_runtime.jsx("input", {
									style: pageStyle.input,
									value: current.asrBaseUrl ?? "",
									onChange: setField("asrBaseUrl"),
									placeholder: t("settings.asrBaseUrlPlaceholder"),
								})]
							}),
							react_jsx_runtime.jsx("label", {
								style: pageStyle.row,
								children: [react_jsx_runtime.jsx("span", { style: pageStyle.label, children: t("settings.asrKeyEnv") }), react_jsx_runtime.jsx("input", {
									style: pageStyle.input,
									value: current.asrKeyEnv ?? "",
									onChange: setField("asrKeyEnv"),
									placeholder: "XIAOMI_API_KEY",
								}), react_jsx_runtime.jsx("span", { style: pageStyle.status, children: t("settings.asrKeyEnvHint") })]
							}),
							react_jsx_runtime.jsx("label", {
								style: pageStyle.row,
								children: [react_jsx_runtime.jsx("span", { style: pageStyle.label, children: t("settings.asrLanguage") }), react_jsx_runtime.jsx("input", {
									style: pageStyle.input,
									value: current.asrLanguage ?? "auto",
									onChange: setField("asrLanguage"),
									placeholder: "auto",
								})]
							}),
						]
