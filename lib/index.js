...
/** 切换触发词: 仅这两个精确词触发切换流程, 其他消息一律进入正常聊天。 */
 ...
 * 策略: 仅精确词「切换会话」「切换工作区」触发; 其余消息一律进入正常聊天。
 * 流程: 待确认选择 (两级: 工作区 → 会话) → 精确词触发 → 列表选择 → 执行切换。
 */
